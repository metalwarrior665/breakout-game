...
const WALL_LEFT_X: f32 = WALL_THICKNESS / 2. - WINDOW_WIDTH as f32 / 2.0;
const WALL_RIGHT_X: f32 = WINDOW_WIDTH as f32 / 2.0 - WALL_THICKNESS / 2.;
const WALL_TOP_Y: f32 = WINDOW_HEIGHT as f32 / 2.0 - WALL_THICKNESS / 2.;
...
pub fn spawn_walls(mut commands: Commands, materials: Res<Materials>) {
    commands
        ...
        .spawn(SpriteComponents {
            ...
            sprite: Sprite::new(Vec2::new(WALL_THICKNESS, WINDOW_HEIGHT as f32)),
        ...
        .spawn(SpriteComponents {
            material: materials.wall_material.clone(),
            sprite: Sprite::new(Vec2::new(WINDOW_WIDTH as f32, WALL_THICKNESS)),
